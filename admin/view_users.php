                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="fullName">Account Username</label>
                                                                    <input type="text" class="form-control mb-4"  placeholder="Full Name" value="<?= $row['acct_username'] ?>" name="acct_username" >
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4"  placeholder="Full Name" value="<?= $row['firstname'] ?>" name="firstname" >
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            <label for="fullName">Last Name</label>
                                                                            <input type="text" class="form-control mb-4"  placeholder="Full Name" value="<?= $row['lastname'] ?>" name="lastname" >
                                                                        </div>
                                                                    </div>
                                                                </div>
