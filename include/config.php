...
define("WEB_URL","http://dashboard.fortageunion.com"); // Change No "/" Ending splash
...
function dbConnect(){
    ...
    $username = "multistream6_fortageunion_back";//DATABASE USERNAME
    $password = "+C@ppy126";//DATABASE PASSWORD
    $database = "multistream6_fortageunion_back";//DATABASE NAME
